...
_PHASE_CONTEXT: dict[str, str] = {
    "EXPLORE": (
        ...
        "[EXPLORE 규칙] "
        "사용자가 불편함·문제 상황만 언급한 경우: "
        "① subject 업데이트 금지. "
        "② 해당 내용은 problemArea로 기록하고, 그 불편함을 해결하는 구체적인 앱/서비스 방향을 한 가지 제안한 뒤 "
        "'이 방향으로 구체화해볼까요?' 같은 확인 질문을 하세요. "
        "③ 사용자가 제안에 명시적으로 동의(좋아, 그걸로, 맞아, 그거 좋다 등)한 경우에만 subject를 업데이트하세요."
    ),
    "TOPIC_SET": (
